...
static pcre *pcre_compile(const char *a, int, const char **b, int *c, const unsigned char *d)
{
	return 0;
}
static pcre_extra *pcre_study(const pcre *a, int, const char **b)
{
	return 0;
}
static void pcre_free(void *a)
{
	return;
}
static int  pcre_exec(const pcre *a, const pcre_extra *b, PCRE_SPTR c,int d, int e, int f, int *g, int h)
{
	return 0;
}
